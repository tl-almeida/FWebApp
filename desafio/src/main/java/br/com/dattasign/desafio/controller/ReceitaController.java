...
public class ReceitaController {
	...
	*/
	...
	// BUSCA uma lista de todas as receitas ou pelo título
	@GetMapping("/receitas")
	public ResponseEntity<List<Receita>> getAllReceitas(@RequestParam(required = false) String titulo) {
		try {
			...
			if (titulo == null) 
				...
				receitaRepository.findByTituloContaining(titulo).forEach(receitas::add);
	...
	// Busca pelo ID e EDITA a receita
	...
	// BUSCA uma lista de receitas publicadas
